...
$cfgServerHost = $nhost;             // MySQL hostname
$cfgServerPort = '';                      // MySQL port - leave blank for default port
$cfgServerUser = $nuser;                  // MySQL user
$cfgServerPassword = $npass;                  // MySQL password

$cfgDbDatabase = $nbase;        // MySQL database name containing phpSecurePages table
$cfgDbTableUsers = 'administrador';         // MySQL table name containing phpSecurePages user fields
$cfgDbLoginfield = 'nombre';                // MySQL field name containing login word
$cfgDbPasswordfield = 'contrasena';         // MySQL field name containing password
$cfgDbUserLevelfield = 'nivel';       // MySQL field name containing user level
...
$cfgDbUserIDfield = 'ID_adm';        // MySQL field name containing user identification
