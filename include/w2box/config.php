...
// --- basic ---
// title of your w2box
$config['w2box_title'] = "POC-CMS - Sistema de Archivos";
// path to the storage directory
$config['storage_path'] = "../../imagenes/noticia";
// maximum allowed file size in megabytes.
$config['max_filesize'] = 50; // MBytes
// allowed file type
$config['allowed_ext'] = array("gif","jpg","jpeg","png");
...
// admin username
$config['admin_username'] = $_SESSION["login"];
// admin password
$config['admin_password'] = $_SESSION["password"];
...
$lang['upload_error_fileexist'] = "exists already in the storage directory.";
