<?php /* Smarty version 2.6.18, created on 2007-07-09 11:34:35
...
<tr>
<td class="login"><a href="http://www.poccms.com" target="_blank" alt="Powered by POC-CMS [<?php echo $this->_tpl_vars['version']; ?>
]"><img src="../imagenes/poccms_small.gif" border="0" align="right"></a><?php echo $this->_tpl_vars['cubologin']; ?>
 <?php echo $this->_tpl_vars['loginmensaje1']; ?>
 <?php echo $this->_tpl_vars['loginmensaje2']; ?>
 <?php echo $this->_tpl_vars['loginmensaje3']; ?>
[<?php echo $this->_tpl_vars['desconectar']; ?>
]<br><?php echo $this->_tpl_vars['loginmensaje4']; ?>


<!--  ################## Inicia Fecha  ################## -->
&nbsp;&nbsp;&nbsp; <BR><?php echo $this->_tpl_vars['fecha']; ?>
