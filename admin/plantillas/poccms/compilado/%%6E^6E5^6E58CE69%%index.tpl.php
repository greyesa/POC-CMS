<?php /* Smarty version 2.6.18, created on 2007-07-09 01:00:33
         compiled from mensprivado/index.tpl */ ?>
...
<?php echo $this->_tpl_vars['mensprivado1']; ?>


<?php echo $this->_tpl_vars['mensprivado2']; ?>


<?php echo $this->_tpl_vars['mensprivado3']; ?>


<?php echo $this->_tpl_vars['mensprivado4']; ?>


<?php unset($this->_sections['contador']);
$this->_sections['contador']['name'] = 'contador';
$this->_sections['contador']['loop'] = is_array($_loop=$this->_tpl_vars['mensprivado44']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<b><?php echo $this->_tpl_vars['mensprivado44'][$this->_sections['contador']['index']]; ?>

<?php endfor; endif; ?>

<?php echo $this->_tpl_vars['mensprivado5']; ?>
<br><br>
<?php echo $this->_tpl_vars['mensprivado6']; ?>

<?php echo $this->_tpl_vars['mensprivado7']; ?>

<?php unset($this->_sections['contador']);
$this->_sections['contador']['name'] = 'contador';
$this->_sections['contador']['loop'] = is_array($_loop=$this->_tpl_vars['mensprivado8']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['contador']['show'] = true;
$this->_sections['contador']['max'] = $this->_sections['contador']['loop'];
$this->_sections['contador']['step'] = 1;
$this->_sections['contador']['start'] = $this->_sections['contador']['step'] > 0 ? 0 : $this->_sections['contador']['loop']-1;
...
$this->_sections['contador']['last']       = ($this->_sections['contador']['iteration'] == $this->_sections['contador']['total']);
?>
<?php echo $this->_tpl_vars['mensprivado8'][$this->_sections['contador']['index']]; ?>

<?php endfor; endif; ?>
<?php unset($this->_sections['contador']);
$this->_sections['contador']['name'] = 'contador';
$this->_sections['contador']['loop'] = is_array($_loop=$this->_tpl_vars['mensprivado9']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['contador']['show'] = true;
$this->_sections['contador']['max'] = $this->_sections['contador']['loop'];
$this->_sections['contador']['step'] = 1;
$this->_sections['contador']['start'] = $this->_sections['contador']['step'] > 0 ? 0 : $this->_sections['contador']['loop']-1;
...
$this->_sections['contador']['last']       = ($this->_sections['contador']['iteration'] == $this->_sections['contador']['total']);
?>
<?php echo $this->_tpl_vars['mensprivado9'][$this->_sections['contador']['index']]; ?>

<?php endfor; endif; ?>
<?php echo $this->_tpl_vars['mensprivado10']; ?>

<?php echo $this->_tpl_vars['mensprivado11']; ?>
